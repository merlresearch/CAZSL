...
class LatentModel(nn.Module):
    ...
    def __init__(self, num_hidden, x_dim=2, y_dim=1, boolean_pred=True):
        ...
        self.latent_encoder = LatentEncoder(num_hidden, num_hidden, input_dim=self.x_dim + self.y_dim)
        self.deterministic_encoder = DeterministicEncoder(num_hidden, num_hidden, x_dim=self.x_dim, y_dim=self.y_dim)
    ...
    def forward(self, context_x, context_y, target_x, target_y=None, test=False):
        ...
        return mu_pred, lstd, kl, loss, mse, log_p
